//
//  Main_TopicCollectionViewCell.m
//  DaMiZhiTongChe
//
...
@implementation Main_TopicCollectionViewCell
...
- (instancetype) initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.nameLabel.textColor = DEFAULTBROWNCOLOR;
        self.nameLabel.font = [UIFont systemFontOfSize:12.0];
        [self.contentView addSubview:self.nameLabel];
        [self.nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self.contentView.mas_top).with.offset(8.0);
            make.left.equalTo(self.logoImageView.mas_right).with.offset(10.0);
        ...
        UIImageView *topicLine = [[UIImageView alloc] init];
        topicLine.image = [UIImage imageNamed:@"topic_line"];
        [self.contentView addSubview:topicLine];
        [topicLine mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self.logoImageView.mas_bottom).with.offset(5.0);
            make.left.equalTo(self.contentView.mas_left).with.offset(10.0);
            make.right.equalTo(rightLine.mas_left).with.offset(-30.0);
            make.height.equalTo(@2.5);
        }];
        self.goodsImageView = [[UIImageView alloc] init];
        [self.contentView addSubview:self.goodsImageView];
        [self.goodsImageView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(topicLine.mas_bottom).with.offset(5.0);
            make.left.equalTo(self.contentView.mas_left).with.offset(10.0);
            make.right.equalTo(rightLine.mas_left).with.offset(-10.0);
