//
//  MineOrderReceivedViewController.m
//  DaMiZhiTongChe
//
...
@interface MineOrderReceivedViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MineOrderReceivedViewController
- (void)viewDidLoad {
    [super viewDidLoad];
